...
class GeneratePdf {
  ...
  Future<void> generateSaleDocument(SalesTransitionModel transactions, PersonalInformationModel personalInformation, BuildContext context, {required bool share}) async {
    final pw.Document doc = pw.Document();
    doc.addPage(
      pw.MultiPage(
        pageFormat: PdfPageFormat.letter.copyWith(marginBottom: 1.5 * PdfPageFormat.cm),
